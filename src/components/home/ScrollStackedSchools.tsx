...
export const ScrollStackedSchools: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-16 lg:top-20 h-[calc(100vh-4.25rem)] lg:h-[calc(100vh-5.25rem)] w-full flex flex-col justify-between pt-2 pb-2 sm:pt-3 sm:pb-3 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden bg-slate-50">
        
        {/* Section Header (Always Visible & Prominent Below Navbar) */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-2 sm:gap-3 z-30 shrink-0 pb-1.5 border-b border-slate-200/50">
