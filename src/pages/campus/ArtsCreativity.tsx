  ...
  return (
    <div className="space-y-20 sm:space-y-28 pb-24">
      <PageHeader
        ...
        tagline="Dedicated studios, recording suites, and an 850-seat grand auditorium for boundless artistic expression."
        breadcrumbs={[
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 rounded-3xl bg-amber-50/70 border border-amber-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-600 mt-0.5">Explore our Olympic-grade swimming pool, athletic arena, and sports grounds.</p>
          </div>
          <Link
